    ...
    <div data-aos="fade-up" id="register" class="card shadow mb-5 col-7 text-left card-center">
        <ul class="list-group list-group-flush">
            <div class="text-center">
                ...
                <br>
                <br>
                Ce site est édité par la société <span class="wtLegalMentionsPropName">NETFLUX</span>.
                <br>
                Siège social : <span class="wtLegalMentionsPropName">NETFLUX</span>, 16
                Boulevard Amiral Mouchez, 76600
                Le Havre, France.s<br>
                Capital social : XXXXX euros<br>
                Téléphone : +33 (0)2 35 24 12 45<br>
                <br>
                Responsable de la rédaction : CHAREF Sarah  et LUCAS Théo <br>
                <br>
                Développement, hébergement : VISUAL STUDIO CODE, NGROK <br><br>
                ...
                société
                <span class="wtLegalMentionsPropName">NETFLUX</span>.<br>
                <br>
                Elles ne font l'objet d'aucune cession à des tiers. <span class="wtLegalMentionsPropName">NETFLUX</span> traite les informations qui vous
                concernent
                avec
                ...
                faire
                la demande par écrit aux coordonnées suivantes : 16
                Boulevard Amiral Mouchez, 76600
                Le Havre, France.
                ...
                propriété
                de
                la société NETFLUX, il est protégé par les lois en vigueur de la législation française sur la propriété
                intellectuelle.<br>
                <br>
                ...
                utiliser
                ce
                site. NETFLUX ne saurait être tenu responsable des éléments en dehors de son contrôle et des dommages
                qui
                ...
                <br>
                <span class="wtLegalMentionsPropName">NETFLUX</span> s'attache à transmettre des informations
                ...
                la
                responsabilité de NETFLUX.<br>
                De même que la société <span class="wtLegalMentionsPropName">NETFLUX</span> ne pourra en aucune façon
            ...
            <div class="mx-auto">
                ...
                <label class="col-sm-12"><button type="button" class="btn btn-outline-success" onclick="javascript:window.location.href='/'"><i class="fas fa-home"></i> Retour au site</button></label>
